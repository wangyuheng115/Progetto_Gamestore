...
function VerificaEta() {
    ...
    if (reg_eta.test(eta) == true) {
        ...
        document.getElementById("controll_eta").innerHTML = "<font color=#f00>Entrez un âge correct!";
    }
}
...
function VerificaHobby() {
    ...
    if (reg_hobby.test(hobby) == true && hobby.length != 0) {
        ...
        document.getElementById("controll_hobby").innerHTML = "<font color=#f00>Entrez un passe-temps approprié!</font>";
    }
}
...
function VerificaNazione() {
    ...
    if (reg_nazione.test(nazione) == true && nazione.length != 0) {
        ...
        document.getElementById("controll_nazione").innerHTML = "<font color=#f00>Veuillez entrer un pays correct!";
    }
}
